...
var eddb = {
	...
	//	wpn_aagf : { name:'Anti-Guardian Zone Resistance', maxgrade:1, mats:[ {hasufr:2},{cacr:1},{tacoch:1} ], fdname:'GuardianWeapon_Sturdy' }, // TODO: does this still exist? or only GuardianModule_Sturdy now?
		...
		ihrp_hd : { name:'Heavy Duty', maxgrade:5, mass:[8,16,24,32,40], hullrnf:[24,36,48,60,72], pwrdraw:[5,10,15,20,25], kinres:[3,6,9,12,15], thmres:[3,6,9,12,15], expres:[3,6,9,12,15], mats:[ {car:1}, {car:1, shem:1}, {car:1, shem:1, hideco:1}, {van:1, shse:1, prco:1}, {tun:1, cosh:1, codyco:1} ], fdname:'HullReinforcement_HeavyDuty' },
		...
		imrp_hd : { name:'Overmass Plating', maxgrade:5, mass:[8,16,24,32,40], dmgprot:[-3,-6,-9,-12,-15], integ:[24,36,48,60,72], mats:[ {car:1}, {car:1, shem:1}, {car:1, shem:1, hideco:1}, {van:1, shse:1, prco:1}, {tun:1, cosh:1, codyco:1} ], fdname:'ModuleReinforcement_HeavyDuty' },
		
		imrp_ir : { name:'Sacrificial Lattice', maxgrade:5, integ:[-4,-8,-12,-16,-20], dmgprot:[6,12,18,24,30], mats:[ {car:1}, {car:1, shem:1}, {car:1, shem:1, hideco:1}, {van:1, shse:1, prco:1}, {tun:1, cosh:1, codyco:1} ], fdname:'ModuleReinforcement_HeavyDuty' },
