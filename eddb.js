...
var eddb = {
	version : 423009904,
	edsy_versions_db : [419039901,423009901,423009904,423009901], /* HTML,CSS,DB,JS */
	...
	//	wpn_aagf : { name:'Anti-Guardian Zone Resistance', maxgrade:1, mats:[ {hasufr:2},{cacr:1},{tacoch:1} ], fdname:'GuardianWeapon_Sturdy' }, // TODO: does this still exist? or only GuardianModule_Sturdy now?
		...
		ihrp_br : { name:'Blast Resistant', maxgrade:5, hullrnf:[3,6,9,12,15], pwrdraw:[3,6,9,12,15], kinres:[-2,-4,-6,-8,-10], thmres:[-2,-4,-6,-8,-10], expres:[12,19,26,33,40], mats:[ {nic:1}, {car:1, zin:1}, {saal:1, van:1, zir:1}, {gaal:1, tun:1, mer:1}, {phal:1, mol:1, rut:1} ], fdname:'HullReinforcement_Explosive' },
		ihrp_hd : { name:'Heavy Duty', maxgrade:5, mass:[8,16,24,32,40], hullrnf:[24,36,48,60,72], pwrdraw:[8,16,24,32,40], kinres:[3,6,9,12,15], thmres:[3,6,9,12,15], expres:[3,6,9,12,15], mats:[ {car:1}, {car:1, shem:1}, {car:1, shem:1, hideco:1}, {van:1, shse:1, prco:1}, {tun:1, cosh:1, codyco:1} ], fdname:'HullReinforcement_HeavyDuty' },
		ihrp_kr : { name:'Kinetic Resistant', maxgrade:5, hullrnf:[3,6,9,12,15], pwrdraw:[3,6,9,12,15], kinres:[12,19,26,33,40], thmres:[-2,-4,-6,-8,-10], expres:[-2,-4,-6,-8,-10], mats:[ {nic:1}, {nic:1, van:1}, {saal:1, van:1, hideco:1}, {gaal:1, tun:1, prco:1}, {phal:1, mol:1, codyco:1} ], fdname:'HullReinforcement_Kinetic' },
		ihrp_lw : { name:'Light Weight', maxgrade:5, mass:[-8,-12,-16,-20,-24], pwrdraw:[-8,-12,-16,-20,-24], hullbst:[8,12,16,20,24], hullrnf:[-4,-8,-12,-16,-20], mats:[ {iro:1}, {iro:1, condco:1}, {iro:1, condco:1, hideco:1}, {ger:1, coce:1, prco:1}, {coce:1, tin:1, migral:1} ], fdname:'HullReinforcement_Advanced' },
		...
		imrp_hd : { name:'Fortified Lattice', maxgrade:5, pwrdraw:[20,40,60,80,100], mass:[20,40,60,80,100], dmgprot:[-8,-16,-24,-32,-40], integ:[50,100,150,200,250], mats:[ {car:1}, {car:1, shem:1}, {car:1, shem:1, hideco:1}, {van:1, shse:1, prco:1}, {tun:1, cosh:1, codyco:1} ], fdname:'ModuleReinforcement_HeavyDuty' },
		
		imrp_ir : { name:'Ablative Sheathing', maxgrade:5, pwrdraw:[8,16,24,32,40], integ:[-6,-12,-18,-24,-30], mass:[8,16,24,32,40], dmgprot:[6,12,18,24,30], mats:[ {car:1}, {car:1, shem:1}, {car:1, shem:1, hideco:1}, {van:1, shse:1, prco:1}, {tun:1, cosh:1, codyco:1} ], fdname:'ModuleReinforcement_HeavyDuty' },
	...
	mtype : {
		...
		hexgg : { 
			...
			modifiable:['damage','distdraw','thmload','bstint','bstrof','bstsize','ammoclip','ammomax','dmgfall', 'mass','integ','pwrdraw','pierce','maximumrng','rldtime','_X_ jitter'],
			blueprints:[ 
			//'wpn_rf',
			'wpn_hc','wpn_lw','wpn_lr','wpn_sr','wpn_stu','misc_agzr'],
		...
		hexgp : {
			...
			modifiable:['pwrdraw','damage','thmload','pierce','shotspd','ammoclip','mass','integ','distdraw','maximumrng','bstint','_X_ ammomax','rldtime','jitter','dmgfall'],
			blueprints:['wpn_oc','wpn_eff','wpn_foc','wpn_lw','wpn_lr','wpn_rf','wpn_sr','wpn_stu', 'misc_agzr'],
		...
		hexgs : {
			...
			modifiable:['mass','pwrdraw','distdraw','thmload','pierce','maximumrng','shotspd','jitter','dmgfall', 'integ','damage','bstint','bstsize','ammoclip','ammomax','rldtime','bstrof'],
			blueprints:[
			//'wpn_lr',
			'wpn_oc','wpn_ds','wpn_eff','wpn_hc','wpn_lw','wpn_rf','wpn_stu', 'misc_agzr'],
		...
		ihrp : {
			...
			modifiable:['mass','hullrnf','kinres','thmres','expres','hullbst','pwrdraw'],
		...
		imrp : {
			...
			modifiable:['mass','dmgprot', 'integ','pwrdraw'],
			blueprints:['misc_agzr', 'imrp_hd', 'imrp_ir'],
		},
	...
	//	704 2 : { mtype:'hc',  cost:        , namekey:70140, name:'Cannon',                                mount:'T', class:4, rating:   , mass:16.00, integ:80, pwrdraw:0.88, boottime:0, dps:15.456, damage:46.060, distdraw:0.800, thmload:2.40, pierce: 90, maximumrng:4500, shotspd: 750, rof:0.336, bstint:2.980,                       ammoclip: 5, ammomax: 100,            rldtime:4.0, brcdmg:43.757, brcpct:95, minbrc:60, maxbrc:90,             kinwgt:100,                                 dmgfall:4500, ammocost: 20, fdid:     null, fdname:'Hpt_Cannon_Turret_Huge', eddbid:null },
		...
		88140 : {mtype:'hexgg',cost:  167250,                name:'Guardian Gauss Cannon',        tag:'G', mount:'F', class:1, rating:'D', mass: 2.00, integ:40, pwrdraw:1.91, boottime:0, dps:48.193, damage:40.000, distdraw:3.800,thmload:15.00, pierce:140, maximumrng:3000, duration:1.2, rof:1.205, bstint:0.830,                       ammoclip: 1, ammomax:  80,            rldtime:1.0, brcdmg:20.000, brcpct:50, minbrc:20, maxbrc:40,             thmwgt:20.000/.40000, kinwgt: 50, axewgt:20.000/.40000, dmgfall:1500, ammocost: 75, limit:'hex', fdid:128891610, fdname:'Hpt_Guardian_GaussCannon_Fixed_Small', eddbid:1784 }, // guardian tech broker
		88220 : {mtype:'hexgg',cost:  543800, namekey:88140, name:'Guardian Gauss Cannon',        tag:'G', mount:'F', class:2, rating:'B', mass: 4.00, integ:42, pwrdraw:2.61, boottime:0, dps:84.337, damage:70.000, distdraw:7.200,thmload:25.00, pierce:140, maximumrng:3000, duration:1.2, rof:1.205, bstint:0.830,                       ammoclip: 1, ammomax:  80,            rldtime:1.0, brcdmg:35.000, brcpct:50, minbrc:20, maxbrc:40,             thmwgt:35.000/.70000, kinwgt: 50, axewgt:35.000/.70000, dmgfall:1500, ammocost: 75, limit:'hex', fdid:128833687, fdname:'Hpt_Guardian_GaussCannon_Fixed_Medium', eddbid:1698 }, // guardian tech broker // verify cost,integ
		
		88143 : {mtype:'hexgp',cost:  176500,                name:'Guardian Plasma Charger',      tag:'G', mount:'F', class:1, rating:'D', mass: 2.00, integ:34, pwrdraw:1.40, boottime:0, dps:15.0  , damage: 3.000, duration:1.8, dmgmul:17.0, distdraw:0.680, thmload:4.21, pierce:65, maximumrng:3000, shotspd:1200, rof:5.0, bstint:0.2, ammoclip:15, ammomax: 200,            rldtime:3.0, brcdmg: 0.750, brcpct:25, minbrc:50, maxbrc:80,             abswgt: 1.500/.03000,  thmwgt:25, kinwgt: 25, axewgt: 1.500/.03000, dmgfall:1000, ammocost:100, limit:'hex', fdid:128891607, fdname:'Hpt_Guardian_PlasmaLauncher_Fixed_Small', eddbid:1781 }, // guardian tech broker // TODO: model duration,dmgmul for min-max dps
		88165 : {mtype:'hexgp',cost:  484050, namekey:88143, name:'Guardian Plasma Charger',      tag:'G', mount:'T', class:1, rating:'F', mass: 2.00, integ:34, pwrdraw:1.60, boottime:0, dps:10.0  , damage: 2.000, duration:1.8, dmgmul:17.0, distdraw:0.800, thmload:5.01, pierce:65, maximumrng:3000, shotspd:1200, rof:5.0, bstint:0.2, ammoclip:15, ammomax: 200,            rldtime:3.0, brcdmg: 0.500, brcpct:25, minbrc:50, maxbrc:80,             abswgt: 1.000/.02000,   thmwgt:25, kinwgt: 25, axewgt: 1.000/.02000, dmgfall:1000, ammocost:100, limit:'hex', fdid:128891606, fdname:'Hpt_Guardian_PlasmaLauncher_Turret_Small', eddbid:1780 }, // guardian tech broker
		88223 : {mtype:'hexgp',cost:  567760, namekey:88143, name:'Guardian Plasma Charger',      tag:'G', mount:'F', class:2, rating:'B', mass: 4.00, integ:42, pwrdraw:2.13, boottime:0, dps:25.0  , damage: 5.000, duration:1.8, dmgmul:17.0, distdraw:1.250, thmload:5.21, pierce:80, maximumrng:3000, shotspd:1200, rof:5.0, bstint:0.2, ammoclip:15, ammomax: 200,            rldtime:3.0, brcdmg: 1.250, brcpct:25, minbrc:50, maxbrc:80,             abswgt: 2.500/.05000,   thmwgt:25, kinwgt: 25, axewgt: 2.500/.05000, dmgfall:1000, ammocost:100, limit:'hex', fdid:128833998, fdname:'Hpt_Guardian_PlasmaLauncher_Fixed_Medium', eddbid:1753 }, // guardian tech broker // verify cost
		88255 : {mtype:'hexgp',cost: 1659200, namekey:88143, name:'Guardian Plasma Charger',      tag:'G', mount:'T', class:2, rating:'E', mass: 4.00, integ:42, pwrdraw:2.01, boottime:0, dps:20.0  , damage: 4.000, duration:1.8, dmgmul:17.0, distdraw:1.400, thmload:5.80, pierce:80, maximumrng:3000, shotspd:1200, rof:5.0, bstint:0.2, ammoclip:15, ammomax: 200,            rldtime:3.0, brcdmg: 1.000, brcpct:25, minbrc:50, maxbrc:80,             abswgt: 2.000/.04000,  thmwgt:25, kinwgt: 25,  axewgt: 2.000/.04000, dmgfall:1000, ammocost:100, limit:'hex', fdid:128833999, fdname:'Hpt_Guardian_PlasmaLauncher_Turret_Medium', eddbid:1754 }, // guardian tech broker // verify cost
		88333 : {mtype:'hexgp',cost: 1423300, namekey:88143, name:'Guardian Plasma Charger',      tag:'G', mount:'F', class:3, rating:'C', mass: 8.00, integ:51, pwrdraw:3.10, boottime:0, dps:35.0  , damage: 7.000, duration:1.8, dmgmul:17.0, distdraw:2.420, thmload:6.15, pierce:95, maximumrng:3000, shotspd:1200, rof:5.0, bstint:0.2, ammoclip:15, ammomax: 200,            rldtime:3.0, brcdmg: 0.350, brcpct: 5, minbrc:50, maxbrc:80,             abswgt: 3.500/.07000,  thmwgt:25, kinwgt: 25,  axewgt: 3.500/.07000, dmgfall:1000, ammocost:100, limit:'hex', fdid:128834783, fdname:'Hpt_Guardian_PlasmaLauncher_Fixed_Large', eddbid:1765 }, // guardian tech broker // verify cost
		88345 : {mtype:'hexgp',cost: 5495200, namekey:88143, name:'Guardian Plasma Charger',      tag:'G', mount:'T', class:3, rating:'D', mass: 8.00, integ:51, pwrdraw:2.53, boottime:0, dps:30.0  , damage: 6.000, duration:1.8, dmgmul:17.0, distdraw:2.600, thmload:6.40, pierce:95, maximumrng:3000, shotspd:1200, rof:5.0, bstint:0.2, ammoclip:15, ammomax: 200,            rldtime:3.0, brcdmg: 1.500, brcpct:25, minbrc:50, maxbrc:80,             abswgt: 3.000/.06000,  thmwgt:25, kinwgt: 25,  axewgt: 3.000/.06000, dmgfall:1000, ammocost:100, limit:'hex', fdid:128834784, fdname:'Hpt_Guardian_PlasmaLauncher_Turret_Large', eddbid:1766 }, // guardian tech broker // verify cost
		
		88146 : {mtype:'hexgs',cost:  151650,                name:'Guardian Shard Cannon',        tag:'G', mount:'F', class:1, rating:'D', mass: 2.00, integ:34, pwrdraw:0.87, boottime:0, dps:72.800, damage: 3.640, distdraw:0.420, thmload:0.69, pierce: 30, maximumrng:1700, shotspd:1133, rof:1.667, bstint:0.600,                       ammoclip: 5, ammomax: 180, rounds:12, rldtime:5.0, brcdmg: 2.912, brcpct:80, minbrc:60, maxbrc:80, jitter:5.0, thmwgt: 1.820/.03640, kinwgt: 50, axewgt: 1.820/.03640, dmgfall:1700, ammocost:  9, limit:'hex', fdid:128891609, fdname:'Hpt_Guardian_ShardCannon_Fixed_Small', eddbid:1783 }, // guardian tech broker
		88168 : {mtype:'hexgs',cost:  502000, namekey:88146, name:'Guardian Shard Cannon',        tag:'G', mount:'T', class:1, rating:'F', mass: 2.00, integ:34, pwrdraw:0.72, boottime:0, dps:40.400, damage: 2.020, distdraw:0.360, thmload:0.58, pierce: 30, maximumrng:1700, shotspd:1133, rof:1.667, bstint:0.600,                       ammoclip: 5, ammomax: 180, rounds:12, rldtime:5.0, brcdmg: 1.616, brcpct:80, minbrc:60, maxbrc:80, jitter:5.0, thmwgt: 1.010/.02020, kinwgt: 50, axewgt: 1.010/.02020, dmgfall:1700, ammocost:  9, limit:'hex', fdid:128891608, fdname:'Hpt_Guardian_ShardCannon_Turret_Small', eddbid:1782 }, // guardian tech broker
		88216 : {mtype:'hexgs',cost:  507760, namekey:88146, name:'Guardian Shard Cannon',        tag:'G', mount:'F', class:2, rating:'A', mass: 4.00, integ:42, pwrdraw:1.21, boottime:0,dps:135.400, damage: 6.770, distdraw:0.650, thmload:1.20, pierce: 45, maximumrng:1700, shotspd:1133, rof:1.667, bstint:0.600,                       ammoclip: 5, ammomax: 180, rounds:12, rldtime:5.0, brcdmg: 5.416, brcpct:80, minbrc:60, maxbrc:80, jitter:5.0, thmwgt: 3.385/.06770, kinwgt: 50, axewgt: 3.385/.06770, dmgfall:1700, ammocost:  9, limit:'hex', fdid:128834000, fdname:'Hpt_Guardian_ShardCannon_Fixed_Medium', eddbid:1755 }, // guardian tech broker // verify cost
		88218 : {mtype:'hexgs',cost: 1767000, namekey:88146, name:'Guardian Shard Cannon',        tag:'G', mount:'T', class:2, rating:'A', mass: 4.00, integ:42, pwrdraw:1.16, boottime:0,dps: 86.800, damage: 4.340, distdraw:0.570, thmload:1.09, pierce: 45, maximumrng:1700, shotspd:1133, rof:1.667, bstint:0.600,                       ammoclip: 5, ammomax: 180, rounds:12, rldtime:5.0, brcdmg: 3.472, brcpct:80, minbrc:60, maxbrc:80, jitter:5.0, thmwgt: 2.170/.04340, kinwgt: 50, axewgt: 2.170/.04340, dmgfall:1700, ammocost:  9, limit:'hex', fdid:128834001, fdname:'Hpt_Guardian_ShardCannon_Turret_Medium', eddbid:1756 }, // guardian tech broker // verify cost
		88336 : {mtype:'hexgs',cost: 1461350, namekey:88146, name:'Guardian Shard Cannon',        tag:'G', mount:'F', class:3, rating:'C', mass: 8.00, integ:51, pwrdraw:1.68, boottime:0,dps:190.000, damage: 9.500, distdraw:1.400, thmload:2.20, pierce: 60, maximumrng:1700, shotspd:1133, rof:1.667, bstint:0.600,                       ammoclip: 5, ammomax: 180, rounds:12, rldtime:5.0, brcdmg: 7.600, brcpct:80, minbrc:60, maxbrc:80, jitter:5.0, thmwgt: 4.750/.09500, kinwgt: 50, axewgt: 4.750/.09500, dmgfall:1700, ammocost:  9, limit:'hex', fdid:128834778, fdname:'Hpt_Guardian_ShardCannon_Fixed_Large', eddbid:1760 }, // guardian tech broker // verify cost
		88348 : {mtype:'hexgs',cost: 5865030, namekey:88146, name:'Guardian Shard Cannon',        tag:'G', mount:'T', class:3, rating:'D', mass: 8.00, integ:51, pwrdraw:1.39, boottime:0,dps:124.000, damage: 6.200, distdraw:1.200, thmload:1.98, pierce: 60, maximumrng:1700, shotspd:1133, rof:1.667, bstint:0.600,                       ammoclip: 5, ammomax: 180, rounds:12, rldtime:5.0, brcdmg: 4.960, brcpct:80, minbrc:60, maxbrc:80, jitter:5.0, thmwgt: 3.100/.06200, kinwgt: 50, axewgt: 3.100/.06200, dmgfall:1700, ammocost:  9, limit:'hex', fdid:128834779, fdname:'Hpt_Guardian_ShardCannon_Turret_Large', eddbid:1761 }, // guardian tech broker // verify cost
		...
		81143 : { mtype:'hmtl',cost:   27480, namekey:81141, name:'Abrasion Blaster',                      mount:'T', class:1, rating:'D', mass: 2.00, integ:40, pwrdraw:0.47, boottime:0, dps:20.000, damage: 4.000, distdraw:2.000, thmload:1.80, pierce: 18, maximumrng:1000, shotspd: 667, rof:5.000, bstint:0.200,                                                                          brcdmg: 0.600, brcpct:15, minbrc:10, maxbrc:20,             thmwgt:100,                                 dmgfall:1000, noblueprints1:{'*':1}, noexpeffects:{'*':1}, fdid:128915459, fdname:'Hpt_Mining_AbrBlstr_Turret_Small', eddbid:1790 },
		...
		81142 : { mtype:'hmtl',cost:    9400, namekey:81140, name:'Mining Laser',                          mount:'T', class:1, rating:'D', mass: 2.00, integ:40, pwrdraw:0.50, boottime:0, dps: 2.000, damage: 2.000, distdraw:1.500, thmload:2.00, pierce: 18, maximumrng: 500,               rof:  1/0, bstint:0    ,                                                                          brcdmg: 0.300, brcpct:15, minbrc:10, maxbrc:20,             thmwgt:100,                                 dmgfall: 300, noblueprints1:{'*':1}, noexpeffects:{'*':1}, fdid:128740819, fdname:'Hpt_MiningLaser_Turret_Small', eddbid:1587 },
		81240 : { mtype:'hmtl',cost:   22580, namekey:81140, name:'Mining Laser',                          mount:'F', class:2, rating:'D', mass: 2.00, integ:51, pwrdraw:0.75, boottime:0, dps: 4.000, damage: 4.000, distdraw:3.000, thmload:4.00, pierce: 18, maximumrng: 500,               rof:  1/0, bstint:0    ,                                                                          brcdmg: 0.600, brcpct:15, minbrc:10, maxbrc:20,             thmwgt:100,                                 dmgfall: 300, noblueprints1:{'*':1}, noexpeffects:{'*':1}, fdid:128049526, fdname:'Hpt_MiningLaser_Fixed_Medium', eddbid:889 },
		81242 : { mtype:'hmtl',cost:   32580, namekey:81140, name:'Mining Laser',                          mount:'T', class:2, rating:'D', mass: 2.00, integ:51, pwrdraw:0.75, boottime:0, dps: 4.000, damage: 4.000, distdraw:3.000, thmload:4.00, pierce: 18, maximumrng: 500,               rof:  1/0, bstint:0    ,                                                                          brcdmg: 0.600, brcpct:15, minbrc:10, maxbrc:20,             thmwgt:100,                                 dmgfall: 300, noblueprints1:{'*':1}, noexpeffects:{'*':1}, fdid:128740820, fdname:'Hpt_MiningLaser_Turret_Medium', eddbid:1588 },
		81144 : { mtype:'hmtl',cost:   33860,                name:'Mining Lance Beam Laser',      tag:'P', mount:'F', class:1, rating:'D', mass: 2.00, integ:40, pwrdraw:0.70, boottime:0, dps: 8.000, damage: 8.000, distdraw:1.750, thmload:6.00, pierce: 18, maximumrng:2000,               rof:  1/0, bstint:0    ,                                                                          brcdmg: 1.200, brcpct:15, minbrc:10, maxbrc:20,             thmwgt:100,                                 dmgfall: 500, noblueprints1:{'*':1}, noexpeffects:{'*':1}, fdid:128671340, fdname:'Hpt_MiningLaser_Fixed_Small_Advanced', eddbid:1479 }, // powerplay
		...
		41250 : { mtype:'cpp', cost:     1980, namekey:41210, name:'Power Plant', class:2, rating:'E', mass:  2.50, integ: 46, pwrcap: 6.40, heateff:1.00, noblueprints1:{misc_agzr:1}, fdid:128064033, fdname:'Int_Powerplant_Size2_Class1', eddbid:891 },
		41240 : { mtype:'cpp', cost:     5930, namekey:41210, name:'Power Plant', class:2, rating:'D', mass:  1.00, integ: 41, pwrcap: 7.20, heateff:0.75, noblueprints1:{misc_agzr:1}, fdid:128064034, fdname:'Int_Powerplant_Size2_Class2', eddbid:892 },
		41230 : { mtype:'cpp', cost:    17790, namekey:41210, name:'Power Plant', class:2, rating:'C', mass:  1.30, integ: 51, pwrcap: 8.00, heateff:0.50, noblueprints1:{misc_agzr:1}, fdid:128064035, fdname:'Int_Powerplant_Size2_Class3', eddbid:893 },
		41220 : { mtype:'cpp', cost:    53380, namekey:41210, name:'Power Plant', class:2, rating:'B', mass:  2.00, integ: 61, pwrcap: 8.80, heateff:0.45, noblueprints1:{misc_agzr:1}, fdid:128064036, fdname:'Int_Powerplant_Size2_Class4', eddbid:894 },
		41210 : { mtype:'cpp', cost:   160140,                name:'Power Plant', class:2, rating:'A', mass:  1.30, integ: 56, pwrcap: 9.60, heateff:0.40, noblueprints1:{misc_agzr:1}, fdid:128064037, fdname:'Int_Powerplant_Size2_Class5', eddbid:895 },
		
		41350 : { mtype:'cpp', cost:     5930, namekey:41210, name:'Power Plant', class:3, rating:'E', mass:  5.00, integ: 58, pwrcap: 8.00, heateff:1.00, noblueprints1:{misc_agzr:1}, fdid:128064038, fdname:'Int_Powerplant_Size3_Class1', eddbid:896 },
		41340 : { mtype:'cpp', cost:    17790, namekey:41210, name:'Power Plant', class:3, rating:'D', mass:  2.00, integ: 51, pwrcap: 9.00, heateff:0.75, noblueprints1:{misc_agzr:1}, fdid:128064039, fdname:'Int_Powerplant_Size3_Class2', eddbid:897 },
		41330 : { mtype:'cpp', cost:    53380, namekey:41210, name:'Power Plant', class:3, rating:'C', mass:  2.50, integ: 64, pwrcap:10.00, heateff:0.50, noblueprints1:{misc_agzr:1}, fdid:128064040, fdname:'Int_Powerplant_Size3_Class3', eddbid:898 },
		41320 : { mtype:'cpp', cost:   160140, namekey:41210, name:'Power Plant', class:3, rating:'B', mass:  4.00, integ: 77, pwrcap:11.00, heateff:0.45, noblueprints1:{misc_agzr:1}, fdid:128064041, fdname:'Int_Powerplant_Size3_Class4', eddbid:899 },
		41310 : { mtype:'cpp', cost:   480410, namekey:41210, name:'Power Plant', class:3, rating:'A', mass:  2.50, integ: 70, pwrcap:12.00, heateff:0.40, noblueprints1:{misc_agzr:1}, fdid:128064042, fdname:'Int_Powerplant_Size3_Class5', eddbid:900 },
		
		41450 : { mtype:'cpp', cost:    17790, namekey:41210, name:'Power Plant', class:4, rating:'E', mass: 10.00, integ: 72, pwrcap:10.40, heateff:1.00, noblueprints1:{misc_agzr:1}, fdid:128064043, fdname:'Int_Powerplant_Size4_Class1', eddbid:901 },
		41440 : { mtype:'cpp', cost:    53380, namekey:41210, name:'Power Plant', class:4, rating:'D', mass:  4.00, integ: 64, pwrcap:11.70, heateff:0.75, noblueprints1:{misc_agzr:1}, fdid:128064044, fdname:'Int_Powerplant_Size4_Class2', eddbid:902 },
		41430 : { mtype:'cpp', cost:   160140, namekey:41210, name:'Power Plant', class:4, rating:'C', mass:  5.00, integ: 80, pwrcap:13.00, heateff:0.50, noblueprints1:{misc_agzr:1}, fdid:128064045, fdname:'Int_Powerplant_Size4_Class3', eddbid:903 },
		41420 : { mtype:'cpp', cost:   480410, namekey:41210, name:'Power Plant', class:4, rating:'B', mass:  8.00, integ: 96, pwrcap:14.30, heateff:0.45, noblueprints1:{misc_agzr:1}, fdid:128064046, fdname:'Int_Powerplant_Size4_Class4', eddbid:904 },
		41410 : { mtype:'cpp', cost:  1441230, namekey:41210, name:'Power Plant', class:4, rating:'A', mass:  5.00, integ: 88, pwrcap:15.60, heateff:0.40, noblueprints1:{misc_agzr:1}, fdid:128064047, fdname:'Int_Powerplant_Size4_Class5', eddbid:905 },
		
		41550 : { mtype:'cpp', cost:    53380, namekey:41210, name:'Power Plant', class:5, rating:'E', mass: 20.00, integ: 86, pwrcap:13.60, heateff:1.00, noblueprints1:{misc_agzr:1}, fdid:128064048, fdname:'Int_Powerplant_Size5_Class1', eddbid:906 },
		41540 : { mtype:'cpp', cost:   160140, namekey:41210, name:'Power Plant', class:5, rating:'D', mass:  8.00, integ: 77, pwrcap:15.30, heateff:0.75, noblueprints1:{misc_agzr:1}, fdid:128064049, fdname:'Int_Powerplant_Size5_Class2', eddbid:907 },
		41530 : { mtype:'cpp', cost:   480410, namekey:41210, name:'Power Plant', class:5, rating:'C', mass: 10.00, integ: 96, pwrcap:17.00, heateff:0.50, noblueprints1:{misc_agzr:1}, fdid:128064050, fdname:'Int_Powerplant_Size5_Class3', eddbid:908 },
		41520 : { mtype:'cpp', cost:  1441230, namekey:41210, name:'Power Plant', class:5, rating:'B', mass: 16.00, integ:115, pwrcap:18.70, heateff:0.45, noblueprints1:{misc_agzr:1}, fdid:128064051, fdname:'Int_Powerplant_Size5_Class4', eddbid:909 },
		41510 : { mtype:'cpp', cost:  4323700, namekey:41210, name:'Power Plant', class:5, rating:'A', mass: 10.00, integ:106, pwrcap:20.40, heateff:0.40, noblueprints1:{misc_agzr:1}, fdid:128064052, fdname:'Int_Powerplant_Size5_Class5', eddbid:910 },
		
		41650 : { mtype:'cpp', cost:   160140, namekey:41210, name:'Power Plant', class:6, rating:'E', mass: 40.00, integ:102, pwrcap:16.80, heateff:1.00, noblueprints1:{misc_agzr:1}, fdid:128064053, fdname:'Int_Powerplant_Size6_Class1', eddbid:911 },
		41640 : { mtype:'cpp', cost:   480410, namekey:41210, name:'Power Plant', class:6, rating:'D', mass: 16.00, integ: 90, pwrcap:18.90, heateff:0.75, noblueprints1:{misc_agzr:1}, fdid:128064054, fdname:'Int_Powerplant_Size6_Class2', eddbid:912 },
		41630 : { mtype:'cpp', cost:  1441230, namekey:41210, name:'Power Plant', class:6, rating:'C', mass: 20.00, integ:113, pwrcap:21.00, heateff:0.50, noblueprints1:{misc_agzr:1}, fdid:128064055, fdname:'Int_Powerplant_Size6_Class3', eddbid:913 },
		41620 : { mtype:'cpp', cost:  4323700, namekey:41210, name:'Power Plant', class:6, rating:'B', mass: 32.00, integ:136, pwrcap:23.10, heateff:0.45, noblueprints1:{misc_agzr:1}, fdid:128064056, fdname:'Int_Powerplant_Size6_Class4', eddbid:914 },
		41610 : { mtype:'cpp', cost: 12971100, namekey:41210, name:'Power Plant', class:6, rating:'A', mass: 20.00, integ:124, pwrcap:25.20, heateff:0.40, noblueprints1:{misc_agzr:1}, fdid:128064057, fdname:'Int_Powerplant_Size6_Class5', eddbid:915 },
		
		41750 : { mtype:'cpp', cost:   480410, namekey:41210, name:'Power Plant', class:7, rating:'E', mass: 80.00, integ:118, pwrcap:20.00, heateff:1.00, noblueprints1:{misc_agzr:1}, fdid:128064058, fdname:'Int_Powerplant_Size7_Class1', eddbid:916 },
		41740 : { mtype:'cpp', cost:  1441230, namekey:41210, name:'Power Plant', class:7, rating:'D', mass: 32.00, integ:105, pwrcap:22.50, heateff:0.75, noblueprints1:{misc_agzr:1}, fdid:128064059, fdname:'Int_Powerplant_Size7_Class2', eddbid:917 },
		41730 : { mtype:'cpp', cost:  4323700, namekey:41210, name:'Power Plant', class:7, rating:'C', mass: 40.00, integ:131, pwrcap:25.00, heateff:0.50, noblueprints1:{misc_agzr:1}, fdid:128064060, fdname:'Int_Powerplant_Size7_Class3', eddbid:918 },
		41720 : { mtype:'cpp', cost: 12971100, namekey:41210, name:'Power Plant', class:7, rating:'B', mass: 64.00, integ:157, pwrcap:27.50, heateff:0.45, noblueprints1:{misc_agzr:1}, fdid:128064061, fdname:'Int_Powerplant_Size7_Class4', eddbid:919 },
		41710 : { mtype:'cpp', cost: 38913290, namekey:41210, name:'Power Plant', class:7, rating:'A', mass: 40.00, integ:144, pwrcap:30.00, heateff:0.40, noblueprints1:{misc_agzr:1}, fdid:128064062, fdname:'Int_Powerplant_Size7_Class5', eddbid:920 },
		
		41850 : { mtype:'cpp', cost:  1441230, namekey:41210, name:'Power Plant', class:8, rating:'E', mass:160.00, integ:135, pwrcap:24.00, heateff:1.00, noblueprints1:{misc_agzr:1}, fdid:128064063, fdname:'Int_Powerplant_Size8_Class1', eddbid:921 },
		41840 : { mtype:'cpp', cost:  4323700, namekey:41210, name:'Power Plant', class:8, rating:'D', mass: 64.00, integ:120, pwrcap:27.00, heateff:0.75, noblueprints1:{misc_agzr:1}, fdid:128064064, fdname:'Int_Powerplant_Size8_Class2', eddbid:922 },
		41830 : { mtype:'cpp', cost: 12971100, namekey:41210, name:'Power Plant', class:8, rating:'C', mass: 80.00, integ:150, pwrcap:30.00, heateff:0.50, noblueprints1:{misc_agzr:1}, fdid:128064065, fdname:'Int_Powerplant_Size8_Class3', eddbid:923 },
		41820 : { mtype:'cpp', cost: 38913290, namekey:41210, name:'Power Plant', class:8, rating:'B', mass:128.00, integ:180, pwrcap:33.00, heateff:0.45, noblueprints1:{misc_agzr:1}, fdid:128064066, fdname:'Int_Powerplant_Size8_Class4', eddbid:924 },
		41810 : { mtype:'cpp', cost:116739870, namekey:41210, name:'Power Plant', class:8, rating:'A', mass: 80.00, integ:165, pwrcap:36.00, heateff:0.40, noblueprints1:{misc_agzr:1}, fdid:128064067, fdname:'Int_Powerplant_Size8_Class5', eddbid:925 },
		
		41211 : { mtype:'cpp', cost:   192170,                name:'Guardian Hybrid Power Plant', tag:'G', class:2, rating:'A', mass: 1.50, integ: 56, pwrcap:12.70, heateff:0.5 , noblueprints1:{cpp_arm:1,cpp_le:1,cpp_oc:1}, fdid:128833988, fdname:'Int_GuardianPowerplant_Size2', eddbid:1743 }, // guardian tech broker
		41311 : { mtype:'cpp', cost:   576490, namekey:41211, name:'Guardian Hybrid Power Plant', tag:'G', class:3, rating:'A', mass: 2.90, integ: 70, pwrcap:15.80, heateff:0.5 , noblueprints1:{cpp_arm:1,cpp_le:1,cpp_oc:1}, fdid:128833989, fdname:'Int_GuardianPowerplant_Size3', eddbid:1744 }, // guardian tech broker
		41411 : { mtype:'cpp', cost:  1729480, namekey:41211, name:'Guardian Hybrid Power Plant', tag:'G', class:4, rating:'A', mass: 5.90, integ: 88, pwrcap:20.60, heateff:0.5 , noblueprints1:{cpp_arm:1,cpp_le:1,cpp_oc:1}, fdid:128833990, fdname:'Int_GuardianPowerplant_Size4', eddbid:1745 }, // guardian tech broker
		41511 : { mtype:'cpp', cost:  5188440, namekey:41211, name:'Guardian Hybrid Power Plant', tag:'G', class:5, rating:'A', mass:11.70, integ:106, pwrcap:26.90, heateff:0.5 , noblueprints1:{cpp_arm:1,cpp_le:1,cpp_oc:1}, fdid:128833991, fdname:'Int_GuardianPowerplant_Size5', eddbid:1746 }, // guardian tech broker
		41611 : { mtype:'cpp', cost: 15565320, namekey:41211, name:'Guardian Hybrid Power Plant', tag:'G', class:6, rating:'A', mass:23.40, integ:124, pwrcap:33.30, heateff:0.5 , noblueprints1:{cpp_arm:1,cpp_le:1,cpp_oc:1}, fdid:128833992, fdname:'Int_GuardianPowerplant_Size6', eddbid:1747 }, // guardian tech broker
		41711 : { mtype:'cpp', cost: 46695950, namekey:41211, name:'Guardian Hybrid Power Plant', tag:'G', class:7, rating:'A', mass:46.80, integ:144, pwrcap:39.60, heateff:0.5 , noblueprints1:{cpp_arm:1,cpp_le:1,cpp_oc:1}, fdid:128833993, fdname:'Int_GuardianPowerplant_Size7', eddbid:1748 }, // guardian tech broker
		41811 : { mtype:'cpp', cost:140087850, namekey:41211, name:'Guardian Hybrid Power Plant', tag:'G', class:8, rating:'A', mass:93.60, integ:165, pwrcap:47.50, heateff:0.5 , noblueprints1:{cpp_arm:1,cpp_le:1,cpp_oc:1}, fdid:128833994, fdname:'Int_GuardianPowerplant_Size8', eddbid:1749 }, // guardian tech broker
	...
	//	43810 : { mtype:'cfsd', cost:         , namekey:43210, name:'Frame Shift Drive', class:8, rating:'A', mass:      , integ:   , pwrdraw:    , boottime:10, fsdoptmass:      , fsdheat:    , maxfuel:     , fuelmul:0.012, fuelpower:2.90, fdid:128064137, fdname:'Int_Hyperdrive_Size8_Class5', eddbid:995 },
		...
		45150 : { mtype:'cpd', cost:     520, namekey:45110, name:'Power Distributor', class:1, rating:'E', mass:  1.30, integ: 36, pwrdraw:0.32, boottime:5, wepcap:10.00, wepchg:1.20, engcap: 8.00, engchg:0.40, syscap: 8.00, syschg:0.40, noblueprints1:{misc_agzr:1}, fdid:128064178, fdname:'Int_PowerDistributor_Size1_Class1', eddbid:1036 },
		45140 : { mtype:'cpd', cost:    1290, namekey:45110, name:'Power Distributor', class:1, rating:'D', mass:  0.50, integ: 32, pwrdraw:0.36, boottime:5, wepcap:11.00, wepchg:1.40, engcap: 9.00, engchg:0.50, syscap: 9.00, syschg:0.50, noblueprints1:{misc_agzr:1}, fdid:128064179, fdname:'Int_PowerDistributor_Size1_Class2', eddbid:1037 },
		45130 : { mtype:'cpd', cost:    3230, namekey:45110, name:'Power Distributor', class:1, rating:'C', mass:  1.30, integ: 40, pwrdraw:0.40, boottime:5, wepcap:12.00, wepchg:1.50, engcap:10.00, engchg:0.50, syscap:10.00, syschg:0.50, noblueprints1:{misc_agzr:1}, fdid:128064180, fdname:'Int_PowerDistributor_Size1_Class3', eddbid:1038 },
		45120 : { mtype:'cpd', cost:    8080, namekey:45110, name:'Power Distributor', class:1, rating:'B', mass:  2.00, integ: 48, pwrdraw:0.44, boottime:5, wepcap:13.00, wepchg:1.70, engcap:11.00, engchg:0.60, syscap:11.00, syschg:0.60, noblueprints1:{misc_agzr:1}, fdid:128064181, fdname:'Int_PowerDistributor_Size1_Class4', eddbid:1039 },
		45110 : { mtype:'cpd', cost:   20200,                name:'Power Distributor', class:1, rating:'A', mass:  1.30, integ: 44, pwrdraw:0.48, boottime:5, wepcap:14.00, wepchg:1.80, engcap:12.00, engchg:0.60, syscap:12.00, syschg:0.60, noblueprints1:{misc_agzr:1}, fdid:128064182, fdname:'Int_PowerDistributor_Size1_Class5', eddbid:1040 },
		
		45250 : { mtype:'cpd', cost:    1450, namekey:45110, name:'Power Distributor', class:2, rating:'E', mass:  2.50, integ: 46, pwrdraw:0.36, boottime:5, wepcap:12.00, wepchg:1.40, engcap:10.00, engchg:0.60, syscap:10.00, syschg:0.60, noblueprints1:{misc_agzr:1}, fdid:128064183, fdname:'Int_PowerDistributor_Size2_Class1', eddbid:1041 },
		45240 : { mtype:'cpd', cost:    3620, namekey:45110, name:'Power Distributor', class:2, rating:'D', mass:  1.00, integ: 41, pwrdraw:0.41, boottime:5, wepcap:14.00, wepchg:1.60, engcap:11.00, engchg:0.60, syscap:11.00, syschg:0.60, noblueprints1:{misc_agzr:1}, fdid:128064184, fdname:'Int_PowerDistributor_Size2_Class2', eddbid:1042 },
		45230 : { mtype:'cpd', cost:    9050, namekey:45110, name:'Power Distributor', class:2, rating:'C', mass:  2.50, integ: 51, pwrdraw:0.45, boottime:5, wepcap:15.00, wepchg:1.80, engcap:12.00, engchg:0.70, syscap:12.00, syschg:0.70, noblueprints1:{misc_agzr:1}, fdid:128064185, fdname:'Int_PowerDistributor_Size2_Class3', eddbid:1043 },
		45220 : { mtype:'cpd', cost:   22620, namekey:45110, name:'Power Distributor', class:2, rating:'B', mass:  4.00, integ: 61, pwrdraw:0.50, boottime:5, wepcap:17.00, wepchg:2.00, engcap:13.00, engchg:0.80, syscap:13.00, syschg:0.80, noblueprints1:{misc_agzr:1}, fdid:128064186, fdname:'Int_PowerDistributor_Size2_Class4', eddbid:1044 },
		45210 : { mtype:'cpd', cost:   56550, namekey:45110, name:'Power Distributor', class:2, rating:'A', mass:  2.50, integ: 56, pwrdraw:0.54, boottime:5, wepcap:18.00, wepchg:2.20, engcap:14.00, engchg:0.80, syscap:14.00, syschg:0.80, noblueprints1:{misc_agzr:1}, fdid:128064187, fdname:'Int_PowerDistributor_Size2_Class5', eddbid:1045 },
		
		45350 : { mtype:'cpd', cost:    4050, namekey:45110, name:'Power Distributor', class:3, rating:'E', mass:  5.00, integ: 58, pwrdraw:0.40, boottime:5, wepcap:16.00, wepchg:1.80, engcap:12.00, engchg:0.90, syscap:12.00, syschg:0.90, noblueprints1:{misc_agzr:1}, fdid:128064188, fdname:'Int_PowerDistributor_Size3_Class1', eddbid:1046 },
		45340 : { mtype:'cpd', cost:   10130, namekey:45110, name:'Power Distributor', class:3, rating:'D', mass:  2.00, integ: 51, pwrdraw:0.45, boottime:5, wepcap:18.00, wepchg:2.10, engcap:14.00, engchg:1.00, syscap:14.00, syschg:1.00, noblueprints1:{misc_agzr:1}, fdid:128064189, fdname:'Int_PowerDistributor_Size3_Class2', eddbid:1047 },
		45330 : { mtype:'cpd', cost:   25330, namekey:45110, name:'Power Distributor', class:3, rating:'C', mass:  5.00, integ: 64, pwrdraw:0.50, boottime:5, wepcap:20.00, wepchg:2.30, engcap:15.00, engchg:1.10, syscap:15.00, syschg:1.10, noblueprints1:{misc_agzr:1}, fdid:128064190, fdname:'Int_PowerDistributor_Size3_Class3', eddbid:1048 },
		45320 : { mtype:'cpd', cost:   63330, namekey:45110, name:'Power Distributor', class:3, rating:'B', mass:  8.00, integ: 77, pwrdraw:0.55, boottime:5, wepcap:22.00, wepchg:2.50, engcap:17.00, engchg:1.20, syscap:17.00, syschg:1.20, noblueprints1:{misc_agzr:1}, fdid:128064191, fdname:'Int_PowerDistributor_Size3_Class4', eddbid:1049 },
		45310 : { mtype:'cpd', cost:  158330, namekey:45110, name:'Power Distributor', class:3, rating:'A', mass:  5.00, integ: 70, pwrdraw:0.60, boottime:5, wepcap:24.00, wepchg:2.80, engcap:18.00, engchg:1.30, syscap:18.00, syschg:1.30, noblueprints1:{misc_agzr:1}, fdid:128064192, fdname:'Int_PowerDistributor_Size3_Class5', eddbid:1050 },
		
		45450 : { mtype:'cpd', cost:   11350, namekey:45110, name:'Power Distributor', class:4, rating:'E', mass: 10.00, integ: 72, pwrdraw:0.45, boottime:5, wepcap:22.00, wepchg:2.30, engcap:15.00, engchg:1.30, syscap:15.00, syschg:1.30, noblueprints1:{misc_agzr:1}, fdid:128064193, fdname:'Int_PowerDistributor_Size4_Class1', eddbid:1051 },
		45440 : { mtype:'cpd', cost:   28370, namekey:45110, name:'Power Distributor', class:4, rating:'D', mass:  4.00, integ: 64, pwrdraw:0.50, boottime:5, wepcap:24.00, wepchg:2.60, engcap:17.00, engchg:1.40, syscap:17.00, syschg:1.40, noblueprints1:{misc_agzr:1}, fdid:128064194, fdname:'Int_PowerDistributor_Size4_Class2', eddbid:1052 },
		45430 : { mtype:'cpd', cost:   70930, namekey:45110, name:'Power Distributor', class:4, rating:'C', mass: 10.00, integ: 80, pwrdraw:0.56, boottime:5, wepcap:27.00, wepchg:2.90, engcap:19.00, engchg:1.60, syscap:19.00, syschg:1.60, noblueprints1:{misc_agzr:1}, fdid:128064195, fdname:'Int_PowerDistributor_Size4_Class3', eddbid:1053 },
		45420 : { mtype:'cpd', cost:  177330, namekey:45110, name:'Power Distributor', class:4, rating:'B', mass: 16.00, integ: 96, pwrdraw:0.62, boottime:5, wepcap:30.00, wepchg:3.20, engcap:21.00, engchg:1.80, syscap:21.00, syschg:1.80, noblueprints1:{misc_agzr:1}, fdid:128064196, fdname:'Int_PowerDistributor_Size4_Class4', eddbid:1054 },
		45410 : { mtype:'cpd', cost:  443330, namekey:45110, name:'Power Distributor', class:4, rating:'A', mass: 10.00, integ: 88, pwrdraw:0.67, boottime:5, wepcap:32.00, wepchg:3.50, engcap:23.00, engchg:1.90, syscap:23.00, syschg:1.90, noblueprints1:{misc_agzr:1}, fdid:128064197, fdname:'Int_PowerDistributor_Size4_Class5', eddbid:1055 },
		
		45550 : { mtype:'cpd', cost:   31780, namekey:45110, name:'Power Distributor', class:5, rating:'E', mass: 20.00, integ: 86, pwrdraw:0.50, boottime:5, wepcap:27.00, wepchg:2.90, engcap:19.00, engchg:1.70, syscap:19.00, syschg:1.70, noblueprints1:{misc_agzr:1}, fdid:128064198, fdname:'Int_PowerDistributor_Size5_Class1', eddbid:1056 },
		45540 : { mtype:'cpd', cost:   79440, namekey:45110, name:'Power Distributor', class:5, rating:'D', mass:  8.00, integ: 77, pwrdraw:0.56, boottime:5, wepcap:31.00, wepchg:3.20, engcap:22.00, engchg:1.90, syscap:22.00, syschg:1.90, noblueprints1:{misc_agzr:1}, fdid:128064199, fdname:'Int_PowerDistributor_Size5_Class2', eddbid:1057 },
		45530 : { mtype:'cpd', cost:  198610, namekey:45110, name:'Power Distributor', class:5, rating:'C', mass: 20.00, integ: 96, pwrdraw:0.62, boottime:5, wepcap:34.00, wepchg:3.60, engcap:24.00, engchg:2.10, syscap:24.00, syschg:2.10, noblueprints1:{misc_agzr:1}, fdid:128064200, fdname:'Int_PowerDistributor_Size5_Class3', eddbid:1058 },
		45520 : { mtype:'cpd', cost:  496530, namekey:45110, name:'Power Distributor', class:5, rating:'B', mass: 32.00, integ:115, pwrdraw:0.68, boottime:5, wepcap:37.00, wepchg:4.00, engcap:26.00, engchg:2.30, syscap:26.00, syschg:2.30, noblueprints1:{misc_agzr:1}, fdid:128064201, fdname:'Int_PowerDistributor_Size5_Class4', eddbid:1059 },
		45510 : { mtype:'cpd', cost: 1241320, namekey:45110, name:'Power Distributor', class:5, rating:'A', mass: 20.00, integ:106, pwrdraw:0.74, boottime:5, wepcap:41.00, wepchg:4.30, engcap:29.00, engchg:2.50, syscap:29.00, syschg:2.50, noblueprints1:{misc_agzr:1}, fdid:128064202, fdname:'Int_PowerDistributor_Size5_Class5', eddbid:1060 },
		
		45650 : { mtype:'cpd', cost:   88980, namekey:45110, name:'Power Distributor', class:6, rating:'E', mass: 40.00, integ:102, pwrdraw:0.54, boottime:5, wepcap:34.00, wepchg:3.40, engcap:23.00, engchg:2.20, syscap:23.00, syschg:2.20, noblueprints1:{misc_agzr:1}, fdid:128064203, fdname:'Int_PowerDistributor_Size6_Class1', eddbid:1061 },
		45640 : { mtype:'cpd', cost:  222440, namekey:45110, name:'Power Distributor', class:6, rating:'D', mass: 16.00, integ: 90, pwrdraw:0.61, boottime:5, wepcap:38.00, wepchg:3.90, engcap:26.00, engchg:2.40, syscap:26.00, syschg:2.40, noblueprints1:{misc_agzr:1}, fdid:128064204, fdname:'Int_PowerDistributor_Size6_Class2', eddbid:1062 },
		45630 : { mtype:'cpd', cost:  556110, namekey:45110, name:'Power Distributor', class:6, rating:'C', mass: 40.00, integ:113, pwrdraw:0.68, boottime:5, wepcap:42.00, wepchg:4.30, engcap:29.00, engchg:2.70, syscap:29.00, syschg:2.70, noblueprints1:{misc_agzr:1}, fdid:128064205, fdname:'Int_PowerDistributor_Size6_Class3', eddbid:1063 },
		45620 : { mtype:'cpd', cost: 1390280, namekey:45110, name:'Power Distributor', class:6, rating:'B', mass: 64.00, integ:136, pwrdraw:0.75, boottime:5, wepcap:46.00, wepchg:4.70, engcap:32.00, engchg:3.00, syscap:32.00, syschg:3.00, noblueprints1:{misc_agzr:1}, fdid:128064206, fdname:'Int_PowerDistributor_Size6_Class4', eddbid:1064 },
		45610 : { mtype:'cpd', cost: 3475690, namekey:45110, name:'Power Distributor', class:6, rating:'A', mass: 40.00, integ:124, pwrdraw:0.82, boottime:5, wepcap:50.00, wepchg:5.20, engcap:35.00, engchg:3.20, syscap:35.00, syschg:3.20, noblueprints1:{misc_agzr:1}, fdid:128064207, fdname:'Int_PowerDistributor_Size6_Class5', eddbid:1065 },
		
		45750 : { mtype:'cpd', cost:  249140, namekey:45110, name:'Power Distributor', class:7, rating:'E', mass: 80.00, integ:118, pwrdraw:0.59, boottime:5, wepcap:41.00, wepchg:4.10, engcap:27.00, engchg:2.60, syscap:27.00, syschg:2.60, noblueprints1:{misc_agzr:1}, fdid:128064208, fdname:'Int_PowerDistributor_Size7_Class1', eddbid:1066 },
		45740 : { mtype:'cpd', cost:  622840, namekey:45110, name:'Power Distributor', class:7, rating:'D', mass: 32.00, integ:105, pwrdraw:0.67, boottime:5, wepcap:46.00, wepchg:4.60, engcap:31.00, engchg:3.00, syscap:31.00, syschg:3.00, noblueprints1:{misc_agzr:1}, fdid:128064209, fdname:'Int_PowerDistributor_Size7_Class2', eddbid:1067 },
		45730 : { mtype:'cpd', cost: 1557110, namekey:45110, name:'Power Distributor', class:7, rating:'C', mass: 80.00, integ:131, pwrdraw:0.74, boottime:5, wepcap:51.00, wepchg:5.10, engcap:34.00, engchg:3.30, syscap:34.00, syschg:3.30, noblueprints1:{misc_agzr:1}, fdid:128064210, fdname:'Int_PowerDistributor_Size7_Class3', eddbid:1068 },
		45720 : { mtype:'cpd', cost: 3892770, namekey:45110, name:'Power Distributor', class:7, rating:'B', mass:128.00, integ:157, pwrdraw:0.81, boottime:5, wepcap:56.00, wepchg:5.60, engcap:37.00, engchg:3.60, syscap:37.00, syschg:3.60, noblueprints1:{misc_agzr:1}, fdid:128064211, fdname:'Int_PowerDistributor_Size7_Class4', eddbid:1069 },
		45710 : { mtype:'cpd', cost: 9731930, namekey:45110, name:'Power Distributor', class:7, rating:'A', mass: 80.00, integ:144, pwrdraw:0.89, boottime:5, wepcap:61.00, wepchg:6.10, engcap:41.00, engchg:4.00, syscap:41.00, syschg:4.00, noblueprints1:{misc_agzr:1}, fdid:128064212, fdname:'Int_PowerDistributor_Size7_Class5', eddbid:1070 },
		
		45850 : { mtype:'cpd', cost:  697580, namekey:45110, name:'Power Distributor', class:8, rating:'E', mass:160.00, integ:135, pwrdraw:0.64, boottime:5, wepcap:48.00, wepchg:4.80, engcap:32.00, engchg:3.20, syscap:32.00, syschg:3.20, noblueprints1:{misc_agzr:1}, fdid:128064213, fdname:'Int_PowerDistributor_Size8_Class1', eddbid:1071 },
		45840 : { mtype:'cpd', cost: 1743960, namekey:45110, name:'Power Distributor', class:8, rating:'D', mass: 64.00, integ:120, pwrdraw:0.72, boottime:5, wepcap:54.00, wepchg:5.40, engcap:36.00, engchg:3.60, syscap:36.00, syschg:3.60, noblueprints1:{misc_agzr:1}, fdid:128064214, fdname:'Int_PowerDistributor_Size8_Class2', eddbid:1072 },
		45830 : { mtype:'cpd', cost: 4359900, namekey:45110, name:'Power Distributor', class:8, rating:'C', mass:160.00, integ:150, pwrdraw:0.80, boottime:5, wepcap:60.00, wepchg:6.00, engcap:40.00, engchg:4.00, syscap:40.00, syschg:4.00, noblueprints1:{misc_agzr:1}, fdid:128064215, fdname:'Int_PowerDistributor_Size8_Class3', eddbid:1073 },
		45820 : { mtype:'cpd', cost:10899760, namekey:45110, name:'Power Distributor', class:8, rating:'B', mass:256.00, integ:180, pwrdraw:0.88, boottime:5, wepcap:66.00, wepchg:6.60, engcap:44.00, engchg:4.40, syscap:44.00, syschg:4.40, noblueprints1:{misc_agzr:1}, fdid:128064216, fdname:'Int_PowerDistributor_Size8_Class4', eddbid:1074 },
		45810 : { mtype:'cpd', cost:27249390, namekey:45110, name:'Power Distributor', class:8, rating:'A', mass:160.00, integ:165, pwrdraw:0.96, boottime:5, wepcap:72.00, wepchg:7.20, engcap:48.00, engchg:4.80, syscap:48.00, syschg:4.80, noblueprints1:{misc_agzr:1}, fdid:128064217, fdname:'Int_PowerDistributor_Size8_Class5', eddbid:1075 },
		
		45111 : { mtype:'cpd', cost:   40960,                name:'Guardian Hybrid Power Distributor', tag:'G', class:1, rating:'A', mass:  1.40, integ: 35, pwrdraw:0.62, boottime:5, pwrbst:4, wepcap:10.00, wepchg: 2.50, engcap: 9.00, engchg:0.80, syscap:10.00, syschg:0.80, noblueprints1:{cpd_ce:1,cpd_ef:1,cpd_hc:1,cpd_sh:1,cpd_sf:1,cpd_wf:1}, fdid:128833980, fdname:'Int_GuardianPowerDistributor_Size1', eddbid:1735 }, // guardian tech broker
		45211 : { mtype:'cpd', cost:  111600, namekey:45111, name:'Guardian Hybrid Power Distributor', tag:'G', class:2, rating:'A', mass:  2.60, integ: 45, pwrdraw:0.73, boottime:5, pwrbst:4, wepcap:13.00, wepchg: 3.10, engcap:11.00, engchg:1.00, syscap:11.00, syschg:1.00, noblueprints1:{cpd_ce:1,cpd_ef:1,cpd_hc:1,cpd_sh:1,cpd_sf:1,cpd_wf:1}, fdid:128833981, fdname:'Int_GuardianPowerDistributor_Size2', eddbid:1736 }, // guardian tech broker
		45311 : { mtype:'cpd', cost:  311370, namekey:45111, name:'Guardian Hybrid Power Distributor', tag:'G', class:3, rating:'A', mass:  5.25, integ: 56, pwrdraw:0.78, boottime:5, pwrbst:4, wepcap:17.00, wepchg: 3.90, engcap:14.00, engchg:1.70, syscap:14.00, syschg:1.70, noblueprints1:{cpd_ce:1,cpd_ef:1,cpd_hc:1,cpd_sh:1,cpd_sf:1,cpd_wf:1}, fdid:128833982, fdname:'Int_GuardianPowerDistributor_Size3', eddbid:1737 }, // guardian tech broker
		45411 : { mtype:'cpd', cost:  868710, namekey:45111, name:'Guardian Hybrid Power Distributor', tag:'G', class:4, rating:'A', mass: 10.50, integ: 70, pwrdraw:0.87, boottime:5, pwrbst:4, wepcap:22.00, wepchg: 4.90, engcap:17.00, engchg:2.50, syscap:17.00, syschg:2.50, noblueprints1:{cpd_ce:1,cpd_ef:1,cpd_hc:1,cpd_sh:1,cpd_sf:1,cpd_wf:1}, fdid:128833983, fdname:'Int_GuardianPowerDistributor_Size4', eddbid:1738 }, // guardian tech broker
		45511 : { mtype:'cpd', cost: 2423690, namekey:45111, name:'Guardian Hybrid Power Distributor', tag:'G', class:5, rating:'A', mass: 21.00, integ: 99, pwrdraw:0.96, boottime:5, pwrbst:4, wepcap:29.00, wepchg: 6.00, engcap:22.00, engchg:3.30, syscap:22.00, syschg:3.30, noblueprints1:{cpd_ce:1,cpd_ef:1,cpd_hc:1,cpd_sh:1,cpd_sf:1,cpd_wf:1}, fdid:128833984, fdname:'Int_GuardianPowerDistributor_Size5', eddbid:1739 }, // guardian tech broker
		45611 : { mtype:'cpd', cost: 6762090, namekey:45111, name:'Guardian Hybrid Power Distributor', tag:'G', class:6, rating:'A', mass: 42.00, integ: 99, pwrdraw:1.07, boottime:5, pwrbst:4, wepcap:35.00, wepchg: 7.30, engcap:26.00, engchg:4.20, syscap:26.00, syschg:4.20, noblueprints1:{cpd_ce:1,cpd_ef:1,cpd_hc:1,cpd_sh:1,cpd_sf:1,cpd_wf:1}, fdid:128833985, fdname:'Int_GuardianPowerDistributor_Size6', eddbid:1740 }, // guardian tech broker
		45711 : { mtype:'cpd', cost:18866230, namekey:45111, name:'Guardian Hybrid Power Distributor', tag:'G', class:7, rating:'A', mass: 84.00, integ:115, pwrdraw:1.16, boottime:5, pwrbst:4, wepcap:43.00, wepchg: 8.50, engcap:31.00, engchg:5.20, syscap:31.00, syschg:5.20, noblueprints1:{cpd_ce:1,cpd_ef:1,cpd_hc:1,cpd_sh:1,cpd_sf:1,cpd_wf:1}, fdid:128833986, fdname:'Int_GuardianPowerDistributor_Size7', eddbid:1741 }, // guardian tech broker
		45811 : { mtype:'cpd', cost:52636790, namekey:45111, name:'Guardian Hybrid Power Distributor', tag:'G', class:8, rating:'A', mass:168.00, integ:132, pwrdraw:1.25, boottime:5, pwrbst:4, wepcap:50.00, wepchg:10.10, engcap:36.00, engchg:6.20, syscap:36.00, syschg:6.20, noblueprints1:{cpd_ce:1,cpd_ef:1,cpd_hc:1,cpd_sh:1,cpd_sf:1,cpd_wf:1}, fdid:128833987, fdname:'Int_GuardianPowerDistributor_Size8', eddbid:1742 }, // guardian tech broker
		...
		26710 : { mtype:'ihblc', cost:6998400, namekey:26110, name:'Hatch Breaker Limpet Controller', class:7, rating:'A', mass: 80.00, integ:157, pwrdraw:0.98, boottime:3, maxlimpet:12, targetrng:6020, lpactrng:6120, limpettime:120, maxspd:500, hacktime: 2, mincargo:5, maxcargo:10, fdid:128066551, fdname:'Int_DroneControl_ResourceSiphon_Size7_Class5', eddbid:1226 },
		 ...
		 4150 : { mtype:'ihrp', cost:     5000, namekey:4140, name:'Hull Reinforcement Package', class:1, rating:'E', mass: 2.00, hullrnf: 80, kinres:0.5, thmres:0.5, expres:0.5, noblueprints1:{misc_agzr:1}, fdid:128668537, fdname:'Int_HullReinforcement_Size1_Class1', eddbid:1373 },
		 4140 : { mtype:'ihrp', cost:    15000,               name:'Hull Reinforcement Package', class:1, rating:'D', mass: 1.00, hullrnf:110, kinres:0.5, thmres:0.5, expres:0.5, noblueprints1:{misc_agzr:1}, fdid:128668538, fdname:'Int_HullReinforcement_Size1_Class2', eddbid:1374 },
		 4250 : { mtype:'ihrp', cost:    12000, namekey:4140, name:'Hull Reinforcement Package', class:2, rating:'E', mass: 4.00, hullrnf:150, kinres:1.0, thmres:1.0, expres:1.0, noblueprints1:{misc_agzr:1}, fdid:128668539, fdname:'Int_HullReinforcement_Size2_Class1', eddbid:1375 },
		 4240 : { mtype:'ihrp', cost:    36000, namekey:4140, name:'Hull Reinforcement Package', class:2, rating:'D', mass: 2.00, hullrnf:190, kinres:1.0, thmres:1.0, expres:1.0, noblueprints1:{misc_agzr:1}, fdid:128668540, fdname:'Int_HullReinforcement_Size2_Class2', eddbid:1376 },
		 4350 : { mtype:'ihrp', cost:    28000, namekey:4140, name:'Hull Reinforcement Package', class:3, rating:'E', mass: 8.00, hullrnf:230, kinres:1.5, thmres:1.5, expres:1.5, noblueprints1:{misc_agzr:1}, fdid:128668541, fdname:'Int_HullReinforcement_Size3_Class1', eddbid:1377 },
		 4340 : { mtype:'ihrp', cost:    84000, namekey:4140, name:'Hull Reinforcement Package', class:3, rating:'D', mass: 4.00, hullrnf:260, kinres:1.5, thmres:1.5, expres:1.5, noblueprints1:{misc_agzr:1}, fdid:128668542, fdname:'Int_HullReinforcement_Size3_Class2', eddbid:1378 },
		 4450 : { mtype:'ihrp', cost:    65000, namekey:4140, name:'Hull Reinforcement Package', class:4, rating:'E', mass:16.00, hullrnf:300, kinres:2.0, thmres:2.0, expres:2.0, noblueprints1:{misc_agzr:1}, fdid:128668543, fdname:'Int_HullReinforcement_Size4_Class1', eddbid:1379 },
		 4440 : { mtype:'ihrp', cost:   195000, namekey:4140, name:'Hull Reinforcement Package', class:4, rating:'D', mass: 8.00, hullrnf:330, kinres:2.0, thmres:2.0, expres:2.0, noblueprints1:{misc_agzr:1}, fdid:128668544, fdname:'Int_HullReinforcement_Size4_Class2', eddbid:1380 },
		 4550 : { mtype:'ihrp', cost:   150000, namekey:4140, name:'Hull Reinforcement Package', class:5, rating:'E', mass:32.00, hullrnf:360, kinres:2.5, thmres:2.5, expres:2.5, noblueprints1:{misc_agzr:1}, fdid:128668545, fdname:'Int_HullReinforcement_Size5_Class1', eddbid:1381 },
		 4540 : { mtype:'ihrp', cost:   450000, namekey:4140, name:'Hull Reinforcement Package', class:5, rating:'D', mass:16.00, hullrnf:390, kinres:2.5, thmres:2.5, expres:2.5, noblueprints1:{misc_agzr:1}, fdid:128668546, fdname:'Int_HullReinforcement_Size5_Class2', eddbid:1382 },
		
		 4151 : { mtype:'ihrp', cost:    10000, namekey:4141, name:'Guardian Hull Reinforcement Package', tag:'G', class:1, rating:'E', mass: 2.00, pwrdraw:0.45, powerlock:1, hullrnf:80*1.5, thmres:2.0, caures:5.0, noblueprints1:{ihrp_br:1,ihrp_hd:1,ihrp_kr:1,ihrp_lw:1,ihrp_tr:1}, fdid:128833945, fdname:'Int_GuardianHullReinforcement_Size1_Class1', eddbid:1700 }, // verify *res // guardian tech broker
		 4141 : { mtype:'ihrp', cost:    30000,               name:'Guardian Hull Reinforcement Package', tag:'G', class:1, rating:'D', mass: 1.00, pwrdraw:0.56, powerlock:1, hullrnf:110*1.5, thmres:2.0, caures:5.0, noblueprints1:{ihrp_br:1,ihrp_hd:1,ihrp_kr:1,ihrp_lw:1,ihrp_tr:1}, fdid:128833946, fdname:'Int_GuardianHullReinforcement_Size1_Class2', eddbid:1701 }, // verify *res // guardian tech broker
		 4251 : { mtype:'ihrp', cost:    24000, namekey:4141, name:'Guardian Hull Reinforcement Package', tag:'G', class:2, rating:'E', mass: 4.00, pwrdraw:0.68, powerlock:1, hullrnf:150*1.5, thmres:2.0, caures:5.0, noblueprints1:{ihrp_br:1,ihrp_hd:1,ihrp_kr:1,ihrp_lw:1,ihrp_tr:1}, fdid:128833947, fdname:'Int_GuardianHullReinforcement_Size2_Class1', eddbid:1702 }, // verify *res // guardian tech broker
		 4241 : { mtype:'ihrp', cost:    72000, namekey:4141, name:'Guardian Hull Reinforcement Package', tag:'G', class:2, rating:'D', mass: 2.00, pwrdraw:0.79, powerlock:1, hullrnf:190*1.5, thmres:2.0, caures:5.0, noblueprints1:{ihrp_br:1,ihrp_hd:1,ihrp_kr:1,ihrp_lw:1,ihrp_tr:1}, fdid:128833948, fdname:'Int_GuardianHullReinforcement_Size2_Class2', eddbid:1703 }, // verify *res // guardian tech broker
		 4351 : { mtype:'ihrp', cost:    57600, namekey:4141, name:'Guardian Hull Reinforcement Package', tag:'G', class:3, rating:'E', mass: 8.00, pwrdraw:0.90, powerlock:1, hullrnf:230*1.5, thmres:2.0, caures:5.0, noblueprints1:{ihrp_br:1,ihrp_hd:1,ihrp_kr:1,ihrp_lw:1,ihrp_tr:1}, fdid:128833949, fdname:'Int_GuardianHullReinforcement_Size3_Class1', eddbid:1704 }, // verify *res // guardian tech broker
		 4341 : { mtype:'ihrp', cost:   172800, namekey:4141, name:'Guardian Hull Reinforcement Package', tag:'G', class:3, rating:'D', mass: 4.00, pwrdraw:1.01, powerlock:1, hullrnf:260*1.5, thmres:2.0, caures:5.0, noblueprints1:{ihrp_br:1,ihrp_hd:1,ihrp_kr:1,ihrp_lw:1,ihrp_tr:1}, fdid:128833950, fdname:'Int_GuardianHullReinforcement_Size3_Class2', eddbid:1705 }, // verify *res // guardian tech broker
		 4451 : { mtype:'ihrp', cost:   138240, namekey:4141, name:'Guardian Hull Reinforcement Package', tag:'G', class:4, rating:'E', mass:16.00, pwrdraw:1.13, powerlock:1, hullrnf:300*1.5, thmres:2.0, caures:5.0, noblueprints1:{ihrp_br:1,ihrp_hd:1,ihrp_kr:1,ihrp_lw:1,ihrp_tr:1}, fdid:128833951, fdname:'Int_GuardianHullReinforcement_Size4_Class1', eddbid:1706 }, // verify *res // guardian tech broker
		 4441 : { mtype:'ihrp', cost:   414720, namekey:4141, name:'Guardian Hull Reinforcement Package', tag:'G', class:4, rating:'D', mass: 8.00, pwrdraw:1.24, powerlock:1, hullrnf:330*1.5, thmres:2.0, caures:5.0, noblueprints1:{ihrp_br:1,ihrp_hd:1,ihrp_kr:1,ihrp_lw:1,ihrp_tr:1}, fdid:128833952, fdname:'Int_GuardianHullReinforcement_Size4_Class2', eddbid:1707 }, // verify *res // guardian tech broker
		 4551 : { mtype:'ihrp', cost:   331780, namekey:4141, name:'Guardian Hull Reinforcement Package', tag:'G', class:5, rating:'E', mass:32.00, pwrdraw:1.35, powerlock:1, hullrnf:360*1.5, thmres:2.0, caures:5.0, noblueprints1:{ihrp_br:1,ihrp_hd:1,ihrp_kr:1,ihrp_lw:1,ihrp_tr:1}, fdid:128833953, fdname:'Int_GuardianHullReinforcement_Size5_Class1', eddbid:1708 }, // verify *res // guardian tech broker
		 4541 : { mtype:'ihrp', cost:   995330, namekey:4141, name:'Guardian Hull Reinforcement Package', tag:'G', class:5, rating:'D', mass:16.00, pwrdraw:1.46, powerlock:1, hullrnf:390*1.5, thmres:2.0, caures:5.0, noblueprints1:{ihrp_br:1,ihrp_hd:1,ihrp_kr:1,ihrp_lw:1,ihrp_tr:1}, fdid:128833954, fdname:'Int_GuardianHullReinforcement_Size5_Class2', eddbid:1709 }, // verify *res // guardian tech broker
		...
		19710 : { mtype:'imlc', cost:  8000000,                name:'Universal Multi-Limpet Controller', class:7, rating:'A', mlctype:'U', mass:140, integ:200, pwrdraw:1.10, boottime:6, maxlimpet: 8, lpactrng: 9100, limpettime:1/0, maxspd:500, multispd:60, fuelxfer:1.0, lmprepcap:310, hacktime: 5, mincargo:5, maxcargo:10, limit:'imlc', fdid:129001930, fdname:'Int_MultiDroneControl_Universal_Size7_Class5', eddbid:1825 },
		 ...
		 8150 : { mtype:'imrp', cost:     5000, namekey:8140, name:'Module Reinforcement Package', class:1, rating:'E', mass: 2.00, integ: 77, dmgprot:30, noblueprints1:{misc_agzr:1}, fdid:128737270, fdname:'Int_ModuleReinforcement_Size1_Class1', eddbid:1577 },
		 8140 : { mtype:'imrp', cost:    15000,               name:'Module Reinforcement Package', class:1, rating:'D', mass: 1.00, integ: 70, dmgprot:60, noblueprints1:{misc_agzr:1}, fdid:128737271, fdname:'Int_ModuleReinforcement_Size1_Class2', eddbid:1578 },
		 8250 : { mtype:'imrp', cost:    12000, namekey:8140, name:'Module Reinforcement Package', class:2, rating:'E', mass: 4.00, integ:115, dmgprot:30, noblueprints1:{misc_agzr:1}, fdid:128737272, fdname:'Int_ModuleReinforcement_Size2_Class1', eddbid:1579 },
		 8240 : { mtype:'imrp', cost:    36000, namekey:8140, name:'Module Reinforcement Package', class:2, rating:'D', mass: 2.00, integ:105, dmgprot:60, noblueprints1:{misc_agzr:1}, fdid:128737273, fdname:'Int_ModuleReinforcement_Size2_Class2', eddbid:1580 },
		 8350 : { mtype:'imrp', cost:    28000, namekey:8140, name:'Module Reinforcement Package', class:3, rating:'E', mass: 8.00, integ:170, dmgprot:30, noblueprints1:{misc_agzr:1}, fdid:128737274, fdname:'Int_ModuleReinforcement_Size3_Class1', eddbid:1581 },
		 8340 : { mtype:'imrp', cost:    84000, namekey:8140, name:'Module Reinforcement Package', class:3, rating:'D', mass: 4.00, integ:155, dmgprot:60, noblueprints1:{misc_agzr:1}, fdid:128737275, fdname:'Int_ModuleReinforcement_Size3_Class2', eddbid:1582 },
		 8450 : { mtype:'imrp', cost:    65000, namekey:8140, name:'Module Reinforcement Package', class:4, rating:'E', mass:16.00, integ:260, dmgprot:30, noblueprints1:{misc_agzr:1}, fdid:128737276, fdname:'Int_ModuleReinforcement_Size4_Class1', eddbid:1583 },
		 8440 : { mtype:'imrp', cost:   195000, namekey:8140, name:'Module Reinforcement Package', class:4, rating:'D', mass: 8.00, integ:235, dmgprot:60, noblueprints1:{misc_agzr:1}, fdid:128737277, fdname:'Int_ModuleReinforcement_Size4_Class2', eddbid:1584 },
		 8550 : { mtype:'imrp', cost:   150000, namekey:8140, name:'Module Reinforcement Package', class:5, rating:'E', mass:32.00, integ:385, dmgprot:30, noblueprints1:{misc_agzr:1}, fdid:128737278, fdname:'Int_ModuleReinforcement_Size5_Class1', eddbid:1585 },
		 8540 : { mtype:'imrp', cost:   450000, namekey:8140, name:'Module Reinforcement Package', class:5, rating:'D', mass:16.00, integ:350, dmgprot:60, noblueprints1:{misc_agzr:1}, fdid:128737279, fdname:'Int_ModuleReinforcement_Size5_Class2', eddbid:1586 },
		
		 8151 : { mtype:'imrp', cost:    10000, namekey:8141, name:'Guardian Module Reinforcement Package', tag:'G', class:1, rating:'E', mass: 2.00, integ: 77*1.5, pwrdraw:0.27, powerlock:1, dmgprot:30, fdid:128833955, fdname:'Int_GuardianModuleReinforcement_Size1_Class1', eddbid:1710 }, // guardian tech broker
		 8141 : { mtype:'imrp', cost:    30000,               name:'Guardian Module Reinforcement Package', tag:'G', class:1, rating:'D', mass: 1.00, integ: 70*1.5, pwrdraw:0.34, powerlock:1, dmgprot:60, fdid:128833956, fdname:'Int_GuardianModuleReinforcement_Size1_Class2', eddbid:1711 }, // guardian tech broker
		 8251 : { mtype:'imrp', cost:    24000, namekey:8141, name:'Guardian Module Reinforcement Package', tag:'G', class:2, rating:'E', mass: 4.00, integ:115*1.5, pwrdraw:0.41, powerlock:1, dmgprot:30, fdid:128833957, fdname:'Int_GuardianModuleReinforcement_Size2_Class1', eddbid:1712 }, // guardian tech broker
		 8241 : { mtype:'imrp', cost:    72000, namekey:8141, name:'Guardian Module Reinforcement Package', tag:'G', class:2, rating:'D', mass: 2.00, integ:105*1.5, pwrdraw:0.47, powerlock:1, dmgprot:60, fdid:128833958, fdname:'Int_GuardianModuleReinforcement_Size2_Class2', eddbid:1713 }, // guardian tech broker
		 8351 : { mtype:'imrp', cost:    57600, namekey:8141, name:'Guardian Module Reinforcement Package', tag:'G', class:3, rating:'E', mass: 8.00, integ:170*1.5, pwrdraw:0.54, powerlock:1, dmgprot:30, fdid:128833959, fdname:'Int_GuardianModuleReinforcement_Size3_Class1', eddbid:1714 }, // guardian tech broker
		 8341 : { mtype:'imrp', cost:   172800, namekey:8141, name:'Guardian Module Reinforcement Package', tag:'G', class:3, rating:'D', mass: 4.00, integ:155*1.5, pwrdraw:0.61, powerlock:1, dmgprot:60, fdid:128833960, fdname:'Int_GuardianModuleReinforcement_Size3_Class2', eddbid:1715 }, // guardian tech broker
		 8451 : { mtype:'imrp', cost:   138240, namekey:8141, name:'Guardian Module Reinforcement Package', tag:'G', class:4, rating:'E', mass:16.00, integ:260*1.5, pwrdraw:0.68, powerlock:1, dmgprot:30, fdid:128833961, fdname:'Int_GuardianModuleReinforcement_Size4_Class1', eddbid:1716 }, // guardian tech broker
		 8441 : { mtype:'imrp', cost:   414720, namekey:8141, name:'Guardian Module Reinforcement Package', tag:'G', class:4, rating:'D', mass: 8.00, integ:235*1.5, pwrdraw:0.74, powerlock:1, dmgprot:60, fdid:128833962, fdname:'Int_GuardianModuleReinforcement_Size4_Class2', eddbid:1717 }, // guardian tech broker
		 8551 : { mtype:'imrp', cost:   331780, namekey:8141, name:'Guardian Module Reinforcement Package', tag:'G', class:5, rating:'E', mass:32.00, integ:385*1.5, pwrdraw:0.81, powerlock:1, dmgprot:30, fdid:128833963, fdname:'Int_GuardianModuleReinforcement_Size5_Class1', eddbid:1718 }, // guardian tech broker
		 8541 : { mtype:'imrp', cost:   995330, namekey:8141, name:'Guardian Module Reinforcement Package', tag:'G', class:5, rating:'D', mass:16.00, integ:350*1.5, pwrdraw:0.88, powerlock:1, dmgprot:60, fdid:128833964, fdname:'Int_GuardianModuleReinforcement_Size5_Class2', eddbid:1719 }, // guardian tech broker
